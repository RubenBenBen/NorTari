...
public class PrototypeManager : MonoBehaviour {
    ...
    public void InitPrototype () {
        ...
        float scale = 14000 / Mathf.Max(spriteRenderer.GetComponent<SpriteRenderer>().sprite.rect.size.x, spriteRenderer.GetComponent<SpriteRenderer>().sprite.rect.size.y);
